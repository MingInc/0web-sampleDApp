        ...
        <div className="mx-auto max-w-[--header-max-w]">
          <div className="relative mb-[87px] flex flex-wrap items-center justify-between md:mb-[95px]">
            <div className="flex items-center gap-x-[3.76px] md:gap-x-[9px]">
              <Link
                className="flex items-center gap-2 text-md text-[#fff]"
                href={"/"}
              >
                <img
                ...
                />
                <span>Starknet dApp sample</span>
              </Link>
              <h4 className="border-l-[1.25px] border-[#fff] px-1 py-[2px] text-xs uppercase italic leading-[14px] text-white md:border-l-[1.75px] md:px-2 md:py-1 md:text-[24px] md:leading-7">
                wikipedia
              </h4>
            </div>
